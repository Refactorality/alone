...
public class HuntActivityTest {
  ...
  public void testGoHuntingNoItems() {
    ...
    if (huntingResult.equals("I guess that's why they don't call it killing. You couldn't get a shot on an animal.")) {
      ...
      assertEquals(
          Optional.of(1000.0).get(), player.getShelter().getFoodCache().get(GameAssets.gameFoods.get("PORCUPINE")));
      assertEquals(Optional.of(1000.0).get(), player.getShelter().getFoodCache().get(GameAssets.gameFoods.get("MOOSE")));
      ...
      assertEquals(
          Optional.of(1000.0 + GameAssets.gameFoods.get("PORCUPINE").getGrams()).get(),
          player.getShelter().getFoodCache().get(GameAssets.gameFoods.get("PORCUPINE")));
      ...
      assertEquals(
          Optional.of(1000.0 + GameAssets.gameFoods.get("MOOSE").getGrams()).get(),
          player.getShelter().getFoodCache().get(GameAssets.gameFoods.get("MOOSE")));
  ...
  public void testGoHuntingWithItems() {
    ...
    if (huntingResult.equals("I guess that's why they don't call it killing. You couldn't get a shot on an animal.")) {
      ...
      assertEquals(7, player.getMorale());
      assertEquals(
          Optional.of(1000.0 + GameAssets.gameFoods.get("PORCUPINE").getGrams() + GameAssets.gameFoods.get("PORCUPINE").getGrams() * 0.1).get(),
          player.getShelter().getFoodCache().get(GameAssets.gameFoods.get("PORCUPINE")),
          0.001);
      assertEquals(HIGH_ACTIVITY_MED_SUCCESS_PLAYER_WEIGHT, player.getWeight(), 0.005);
      assertEquals(previousHydration - ActivityLevel.HIGH.getHydrationCost(SuccessRate.MEDIUM), player.getHydration());
      ...
      assertEquals(9, player.getMorale());
      assertEquals(
          Optional.of(1000.0 + GameAssets.gameFoods.get("MOOSE").getGrams() + GameAssets.gameFoods.get("MOOSE").getGrams() * 0.1).get(),
          player.getShelter().getFoodCache().get(GameAssets.gameFoods.get("MOOSE")),
          0.001);
      assertEquals(HIGH_ACTIVITY_HIGH_SUCCESS_PLAYER_WEIGHT, player.getWeight(), 0.005);
      assertEquals(previousHydration - ActivityLevel.HIGH.getHydrationCost(SuccessRate.HIGH), player.getHydration());
